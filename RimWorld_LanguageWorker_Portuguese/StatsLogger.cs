...
namespace RimWorld_LanguageWorker_Portuguese
{
	...
	public class StatsLogger : IDisposable
	{
		...
		private static Logger logNotProcessed = new Logger("PostProcessed_no_Portuguese.txt");
		private static Logger logInProcessed = new Logger("PostProcessed_in_Portuguese.txt");
		private static Logger logOutProcessed = new Logger("PostProcessed_out_Portuguese.txt");
		private static Logger logStats = new Logger("PostProcessed_stats_Portuguese.txt");
