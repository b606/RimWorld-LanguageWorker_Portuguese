// <code-header>
//   <summary>
//		LanguageWorker_Portuguese.cs contains the main functions destined
//		to inclusion in the RimWorld LanguageWorker_Portuguese class
...
{
	public partial class LanguageWorker_Portuguese : LanguageWorker
	{
		public LanguageWorker_Portuguese()
		{
			//StartStatsLogging(new StackTrace());
			LogMessage("--LanguageWorker_Portuguese ctor called.");
		...
		// TODO: adapt to Portuguese typography.
