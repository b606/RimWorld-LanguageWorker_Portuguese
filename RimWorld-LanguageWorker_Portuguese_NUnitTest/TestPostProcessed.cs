...
using RimWorld_LanguageWorker_Portuguese;

namespace RimWorldLanguageWorPortugueseish_NUnitTest
{
	[TestFixture]
	public class TestPostProcessed
	{
		...
		{
			LanguageWorker_Portuguese _lw = new LanguageWorker_Portuguese();
